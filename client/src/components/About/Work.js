      ...
      <div className="container">
        <div className="row">
          <div className="col-md-7 company-stores">
            ...
            <p className="basic">
              When it comes to e-commerce, templates don’t work. We build
              tailored, elegant and easy-to-use company stores that are
              regularly refreshed with new and unique products. Our in-house
              team of six full-time web developers design, develop and manage
              over 100 different company stores that are completely customized
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-8">
              ...
              <p className="basic" style={{ marginBottom: "40px" }}>
                Overture is dedicated to community engagement,{" "}
                <Link
                  to="/sustainability"
              ...
              <Link to="/csr" className="giveback-button">
                CSR AT OVERTURE
              </Link>
            </div>
          </div>
      ...
      <Parallax bgImage={HowImage} strength={700}>
        <div style={{ height: 500 }}>
          <div className="how-box">
            ...
            <p className="basic">
              We’re always streamlining processes and improving quality by
              leveraging our full suite of in-house services, including domestic
              and international sourcing of promotional products, graphic
              design, web development, on-site screen printing and embroidery,
              140,000 square feet of warehouse space, kit assembly, packing, and
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-8 service-div">
            ...
            <p className="basic">
              We invest in technology to improve our responsiveness. We respond
              quickly. We work proactively to send you new product ideas. We
              learn your business and are fierce protectors of your brand. We're
              resourceful problem-solvers and honest about things we can't do.
            </p>
          </div>
        </div>
      </div>
