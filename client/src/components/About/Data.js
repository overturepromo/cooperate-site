                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-md-7 responsible">
                            ...
                            <p className="basic">We’re serious about investing in technology to streamline processes and improve quality and inventory control. We are assiduous in our security precautions to protect our customers’ data and consumer privacy. We are CCPA compliant. We work with the Quality Certification Alliance, the promotional product industry’s only independent, non-profit organization dedicated to certifying manufacturers’ processes for product quality and safety, supply chain security, ethical manufacturing compliance, and environmental stewardship. We believe so strongly in the importance of their work that we serve on QCA’s Distributor Advocacy Council. We have long-standing relationships with many certified factories in China, all audited regularly by QCA or third-party certification experts Intertek or SGS, and have staff on the ground in China and Bangladesh for quality control.</p>
