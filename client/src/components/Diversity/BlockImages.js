            ...
            <div className="container">
                <div className="row block-row">
                    <div className="col-md-6">
                        <img src={ImageOne} className="diverse-img" />
                    </div>
                    <div className="col-md-6">
                ...
                <div className="row block-row">
                    <div className="col-md-6">
                        <img src={ImageThree} className="diverse-img" />
                    </div>
                    <div className="col-md-6">
                        <h1 className="diversity-big">informed</h1>
                        <h4 className="diversity-orange">DIAC's Mission Statement</h4>
                        <p className="basic"><strong>Our first project as a team was to develop our mission statement:</strong> Overture is an involved, informed, and inclusive organization that accepts, celebrates, and showcases the uniqueness of our workforce. Weird is cool. Different is ideal. Identity is ever-evolving. Diversity is how we grow.</p>
                    </div>
                </div>
            </div>
        </div>
