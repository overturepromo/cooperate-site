...
class ACWaukegan extends Component {
    ...
    render(){
        return (
            <div>
                <p style={{color: 'gray'}}><strong>Summary: </strong>The Purchasing Coordinator is primarily responsible for purchasing promotional product inventory for the 100+ ecommerce stores hosted by Overture.</p>
                ...
                <ul style={{color: "gray"}}>
                    ...
                    <li>ommunicate regularly with Senior Management on the reordering process, discuss any operational challenges and any suggested improvements to the process to ensure a seamless customer experience</li>
