    ...
    render(){
        return (
            <div>
                ...
                <ul style={{color: "gray"}}>
                    <li>Provide leadership, training and development to a team of Purchasing Assistants or Coordinators that will directly report into this role</li>
