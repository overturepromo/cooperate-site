    ...
    return (
      <div className="container">
        ...
        <div className="row">
          ...
          />
          <Employee
            image={People.Rolando.image}
            name={People.Rolando.name}
            title={People.Rolando.title}
          />
          <Employee
          ...
          />
          <Employee
            image={People.Carolina.image}
            name={People.Carolina.name}
            title={People.Carolina.title}
          />
          <Employee
          ...
          />
          <Employee
            image={People.MelG.image}
            name={People.MelG.name}
            title={People.MelG.title}
          />
          <Employee
          ...
          />
          <Employee
            image={People.JoseG.image}
            name={People.JoseG.name}
            title={People.JoseG.title}
          />
          <Employee
