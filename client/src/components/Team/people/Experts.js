...
import Jeremy from "../../../images/team/ExpertsPhotos/Jeremy Manning.png";
...
export const People = {
  ...
  ChristinaN: {
    ...
    vacation:
      "Vacation, what’s vacation?  My dream vacation spot would be to take my little man to Disney World someday…then maybe it will become my favorite vacation spot, or not I suppose depending on the time of year we go.  😉",
  ...
  AimeeE: {
    ...
    movie:
      "Cannot pick: it is between Breaking Bad, Handmaid’s Tale, and The Night Of",
  ...
  BenB: {
    ...
    vacation:
      "Santa Barbara, CA. Get to see family and the beautiful California coast all at the same time!",
  ...
  CynthiaL: {
    ...
    movie:
      "Most recently the series Reign, historical fiction, has gripped my interest.",
    vacation:
      "Storfjord Hotel, Skodje, Norway, Bora Bora, New Zealand-South Island ",
  ...
  LarryB: {
    ...
    movie:
      "Any great comedy does it for me. After all, they say laughter may not add years to your life, but will surely add life to your years.",
    vacation:
      "Anywhere on a boat, with hot weather, hotter fishing, and lots of cold drinks.",
  ...
  LauraI: {
    ...
    movie:
      "Braveheart - It's all about the scenery with a little historical heritage for me.",
  ...
  David: {
    ...
    movie:
      "Kelly’s Hero’s staring Clint Eastwood and Donald Sutherland and many other great actors.",
  ...
  BruceR: {
    ...
    movie:
      "The Bourne trilogy, keeps me interested with the adventure and action. Just like my average work day.",
  ...
  Dean: {
    ...
    vacation:
      "This is a tough one, but the one place I am just dying to go back to is Osaka, Japan. From the culture, to the food, to the scenery and everything along the way, it was easily the most fun I have ever had on vacation.",
