        ...
        return (
            <div className="container">
                ...
                <div className="row">
                    ...
                    <Employee image={People.AmyB.image} name={People.AmyB.name} title={People.AmyB.title} />
                    ...
                    <Employee image={People.Julia.image} name={People.Julia.name} title={People.Julia.title} />
                    ...
                    <Employee image={People.Kara.image} name={People.Kara.name} title={People.Kara.title} />
                    ...
                    <Employee image={People.Stella.image} name={People.Stella.name} title={People.Stella.title} />
