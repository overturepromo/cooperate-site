    ...
    return (
      <div className="container">
        ...
        <div className="row">
          ...
          />
          <Employee
            image={People.Angela.image}
            name={People.Angela.name}
          ...
          />
          <Employee
            image={People.ChrisM.image}
            name={People.ChrisM.name}
            title={People.ChrisM.title}
          />
          <Employee
          ...
          />
          <Employee
            image={People.Lynette.image}
            name={People.Lynette.name}
            title={People.Lynette.title}
          />
          <Employee
          ...
          />
          <Employee
            image={People.Nolan.image}
            name={People.Nolan.name}
            title={People.Nolan.title}
          />
          <Employee
