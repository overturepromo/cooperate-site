        ...
        return (
            <div className="container">
                ...
                <div className="row">
                    ...
                    <Employee image={People.AlexO.image} name={People.AlexO.name} title={People.AlexO.title} />
                    <Employee image={People.AndresD.image} name={People.AndresD.name} title={People.AndresD.title} />
                    <Employee image={People.AraceliG.image} name={People.AraceliG.name} title={People.AraceliG.title} />
                    <Employee image={People.ArmandoR.image} name={People.ArmandoR.name} title={People.ArmandoR.title} />
                    <Employee image={People.BridianaO.image} name={People.BridianaO.name} title={People.BridianaO.title} />
                    <Employee image={People.DenineR.image} name={People.DenineR.name} title={People.DenineR.title} />
                    <Employee image={People.DianaC.image} name={People.DianaC.name} title={People.DianaC.title} />
                    <Employee image={People.EduardoS.image} name={People.EduardoS.name} title={People.EduardoS.title} />
                    <Employee image={People.ElisaG.image} name={People.ElisaG.name} title={People.ElisaG.title} />
                    <Employee image={People.EmmelyM.image} name={People.EmmelyM.name} title={People.EmmelyM.title} />
                    <Employee image={People.IvonR.image} name={People.IvonR.name} title={People.IvonR.title} />
                    <Employee image={People.JuanaC.image} name={People.JuanaC.name} title={People.JuanaC.title} />
                    <Employee image={People.LauraG.image} name={People.LauraG.name} title={People.LauraG.title} />
                    <Employee image={People.LizbethM.image} name={People.LizbethM.name} title={People.LizbethM.title} />
                    <Employee image={People.LucyG.image} name={People.LucyG.name} title={People.LucyG.title} />
                    <Employee image={People.MariaQ.image} name={People.MariaQ.name} title={People.MariaQ.title} />
                    <Employee image={People.MariaS.image} name={People.MariaS.name} title={People.MariaS.title} />
                    <Employee image={People.MiroslavaC.image} name={People.MiroslavaC.name} title={People.MiroslavaC.title} />
                    <Employee image={People.NallelyZ.image} name={People.NallelyZ.name} title={People.NallelyZ.title} />
                    <Employee image={People.NemecisF.image} name={People.NemecisF.name} title={People.NemecisF.title} />
                    <Employee image={People.SelenaM.image} name={People.SelenaM.name} title={People.SelenaM.title} />
                    <Employee image={People.VeronicaT.image} name={People.VeronicaT.name} title={People.VeronicaT.title} />
                    <Employee image={People.VictorV.image} name={People.VictorV.name} title={People.VictorV.title} />
                    <Employee image={People.ZaidV.image} name={People.ZaidV.name} title={People.ZaidV.title} />
                ...
                <div className="row" style={{marginBottom: '50px'}}>
                    ...
                    <NotPictured name={People.AnaR.name} title={People.AnaR.title} />
                    <NotPictured name={People.AndreT.name} title={People.AndreT.title} />
                    <NotPictured name={People.Francisco.name} title={People.Francisco.title} />
                    <NotPictured name={People.Iziss.name} title={People.Iziss.title} />
                    <NotPictured name={People.MichaelA.name} title={People.MichaelA.title} />
