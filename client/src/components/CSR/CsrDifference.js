        ...
        <div className="csr-difference">
            <div className="container">
                ...
                <ul className="basic-csr">
                    ...
                    <li>Overture employees participates annually in the Special Olympics Polar Plunge.</li>
                ...
                <ul className="basic-csr">
                    ...
                    <li>Overture worked with a local clinic to ensure all employees had early access to vaccines. Our staff is 83% vaccinated</li>
                </ul>
                ...
                <p className="basic-csr">For more information on Overture’s CSR initiatives, download our annual CSR Report.</p>
            </div>
        </div>
    )
}
