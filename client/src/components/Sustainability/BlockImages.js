            ...
            <div className="container">
                <div className="row block-row">
                    <div className="col-md-6">
                        <img src={ImageOne} className="sus-img" />
                    </div>
                    <div className="col-md-6">
                ...
                <div className="row block-row flippy-stuff">
                    <div className="col-md-6">
                        ...
                        <p className="basic">Overture is committed to conducting business in an environmentally responsible manner and educating our clients, employees, and the public on best, eco-friendly practices. We are dedicated to annual growth in improving the quality of the environment.</p>
                    </div>
                    <div className="col-md-6">
                        <img src={ImageTwo} className="sus-img" />
                    </div>
                </div>
            </div>
        </div>
