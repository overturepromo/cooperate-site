        ...
        return (
            <div className="kitting-contact-form">
                <div className="container">
                    <h4 className="long-kitting-green" style={{textAlign: 'center'}}>Ready to create something extraordinary? Get in touch!</h4>
                    ...
                    <div className="col-md-8 col-md-offset-2">
                        <form onSubmit={this.handleSubmit} className="contact-form row">
                            ...
                            <div className="col-xs-12 contact-inputs-box">
                                <textarea className="contact-inputs text-area-contact" type='text' name="message" required placeholder="Briefly describe how we can help with your kitting needs*" value={this.state.message} onChange={this.handleChange} />
                            </div>
